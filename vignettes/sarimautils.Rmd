...
This vignette demonstrates the functionality provided by the sarima_utils
...
#debug(sample_predictive_trajectories_arima_wrapper)

sampled_trajectories_bc_transform <-
  sample_predictive_trajectories_arima_wrapper(
    sarima_fit = sarima_fit_bc_transform,
